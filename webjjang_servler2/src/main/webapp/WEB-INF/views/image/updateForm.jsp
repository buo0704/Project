...
<input type="hidden" name="page" value="${param.page }"> <!-- 20240624 -->
<input type="hidden" name="perPageNum" value="${param.perPageNum }"> <!-- 20240624 -->
<input type="hidden" name="key" value="${param.key }"> <!-- 20240624 -->
<input type="hidden" name="word" value="${param.word }"> <!-- 20240624 -->
	<table class="table">
		<!-- tr : table row - 테이블 한줄 -->
		<tr>
