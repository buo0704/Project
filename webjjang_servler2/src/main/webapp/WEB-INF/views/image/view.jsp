			...
			<tr>
				<td colspan="2">
					...
					<a href="updateForm.do	?no=${param.no }&page=${param.page }&perPageNum=${param.perPageNum}
						&key=${param.key}&word=${param.word}" class="btn btn-primary">수정</a>
					<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#myModal" >
					삭제
					</button>
					<a href="list.do?page=${param.page }&perPageNum=${param.perPageNum}
						&key=${param.key}&word=${param.word}" class="btn btn-info">리스트</a>
				</td>
			</tr>
		</table>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<input type="hidden" name="no" value="${param.no }">  
					...
					<input class="form-control" placeholder="비밀번호 입력"  name="pw">
					</div>
